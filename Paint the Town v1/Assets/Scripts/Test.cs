...
public class Shader_changing : MonoBehaviour {
	...
	private GameObject prevObj, currObj;
	...
	{	
		...
		if (redPaint && greenPaint && bluePaint) {
			...
			hit.transform.gameObject.GetComponent<Animator>().Play("Default Take");
		}
	}
